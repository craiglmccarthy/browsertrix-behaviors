...
class BehaviorManager
{
  constructor() {
    this.behaviors = [];
    this.loadedBehaviors = _site__WEBPACK_IMPORTED_MODULE_4__.default.reduce((behaviors, next) => {
  ...
  async resolve(target) {
    const imported = await __webpack_require__("./src lazy recursive ^.*$")(`${target}`); // avoid Webpack warning
  ...
  async runOne(name, behaviorOpts = {}) {
    const siteBehaviorClass = _site__WEBPACK_IMPORTED_MODULE_4__.default.find(b => b.name === name);
...
/* harmony export */   "IcaewComBehavior": () => (/* binding */ IcaewComBehavior)
/* harmony export */ });
/* harmony import */ var _lib_behavior__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/behavior */ "./src/lib/behavior.js");
/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../lib/utils */ "./src/lib/utils.js");
/* src/site/icaew-com.js */
...
class IcaewComBehavior extends _lib_behavior__WEBPACK_IMPORTED_MODULE_0__.Behavior {
  static get name() {
    return "ICAEW.com";
  }
...
/* harmony import */ var _icaew_com__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./icaew-com */ "./src/site/icaew-com.js");
...
const siteBehaviors = [
  ...
  _icaew_com__WEBPACK_IMPORTED_MODULE_5__.IcaewComBehavior
];
...
class TikTokVideoBehavior extends _lib_behavior__WEBPACK_IMPORTED_MODULE_0__.Behavior {
  ...
  async* [Symbol.asyncIterator]() {
    const commentList = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.xpathNode)(Q.commentList);
    const commentItems = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.iterChildMatches)(Q.commentItem, commentList);
...
class TikTokProfileBehavior extends _lib_behavior__WEBPACK_IMPORTED_MODULE_0__.Behavior {
  static get name() {
    return "TikTokVideo";
  }
  ...
  async* openVideo(item) {
    const link = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.xpathNode)(".//a", item);
    if (!link) return;
    const viewState = new _lib_utils__WEBPACK_IMPORTED_MODULE_1__.HistoryState(() => link.click());
    await (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.sleep)(500);
  ...
  async* [Symbol.asyncIterator]() {
    const profileVideoList = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.xpathNode)(Q.profileVideoList);
    const profileVideos = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.iterChildMatches)(Q.profileVideoItem, profileVideoList);
...
var map = {
	".": "./src/index.js",
	"./": "./src/index.js",
	"./autofetcher": "./src/autofetcher.js",
	"./autofetcher.js": "./src/autofetcher.js",
	"./autoplay": "./src/autoplay.js",
	"./autoplay.js": "./src/autoplay.js",
	"./autoscroll": "./src/autoscroll.js",
	"./autoscroll.js": "./src/autoscroll.js",
	"./index": "./src/index.js",
	"./index.js": "./src/index.js",
	"./lib/behavior": "./src/lib/behavior.js",
	"./lib/behavior.js": "./src/lib/behavior.js",
	"./lib/utils": "./src/lib/utils.js",
	"./lib/utils.js": "./src/lib/utils.js",
	"./site": "./src/site/index.js",
	"./site/": "./src/site/index.js",
	"./site/facebook": "./src/site/facebook.js",
	"./site/facebook.js": "./src/site/facebook.js",
	"./site/icaew-com": "./src/site/icaew-com.js",
	"./site/icaew-com.js": "./src/site/icaew-com.js",
	"./site/index": "./src/site/index.js",
	"./site/index.js": "./src/site/index.js",
	"./site/instagram": "./src/site/instagram.js",
	"./site/instagram.js": "./src/site/instagram.js",
	"./site/telegram": "./src/site/telegram.js",
	"./site/telegram.js": "./src/site/telegram.js",
	"./site/tiktok": "./src/site/tiktok.js",
	"./site/tiktok.js": "./src/site/tiktok.js",
	"./site/twitter": "./src/site/twitter.js",
	"./site/twitter.js": "./src/site/twitter.js"
};
